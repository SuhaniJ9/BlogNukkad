  ...
  <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
    <div className="mb-4">
      <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
        <p className="text-base font-semibold uppercase tracking-wide text-blue-600 dark:text-[#bc4749]">
          Contact
        </p>
            ...
            <div className="mb-6">
              <div className="mx-0 mb-1 sm:mb-4">
                <div className="mx-0 mb-1 sm:mb-4">
                  ...
                  <input
                    ...
                    className="mb-2 w-full rounded-md border border-dark:text-[#bc4749] py-2 pl-2 pr-4 shadow-md sm:mb-0"
                    name="name"
                  />
                </div>
                <div className="mx-0 mb-1 sm:mb-4">
              ...
              <div className="mx-0 mb-1 sm:mb-4">
                ...
                <textarea
                  ...
                  className="mb-2 w-full bg-black-200 text-white rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"
                  defaultValue={""}
                />
              </div>
            </div>
